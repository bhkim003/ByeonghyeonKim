...
my_snn_system(  devices = "1",
                ...
                my_seed = 7779,
                TIME = 5, # dvscifar 10 # ottt 6 or 10 # nda 10  # 제작하는 dvs에서 TIME넘거나 적으면 자르거나 PADDING함
...
# 'DVS_GESTURE', 'DVS_GESTURE_TONIC','DVS_CIFAR10_2','NMNIST','NMNIST_TONIC','CIFAR10','N_CALTECH101','n_tidigits','heidelberg'
                ...
                lif_layer_sg_width = 12.0 * 2, # 2.570969004857107 # sigmoid류에서는 alpha값 4.0, rectangle류에서는 width값 0.5
                ...
                lif_layer_sg_width2 = 12.0 * 2,
                lif_layer_v_threshold2 = 256,
                learning_rate2 = 2,
